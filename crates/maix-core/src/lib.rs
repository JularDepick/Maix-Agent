...
//! - **Identity** ([`identity`]) — identity/personality management
//! - **Permissions** ([`permissions`]) — tool permission checking
//! - **Model Router** ([`model_router`]) — multi-model routing
//! - **Plugin** ([`plugin`]) — plugin discovery and management
//! - **Tokenizer** ([`tokenizer`]) — token counting and cost estimation
//!
//! ## Quick Start
//!
//! ```rust,no_run
